...
class AtAddressMap extends StatefulWidget {
  const AtAddressMap({Key key}) : super(key: key);

  @override
  _AtAddressMapState createState() => _AtAddressMapState();
}

class _AtAddressMapState extends State<AtAddressMap> {
  Position position;
